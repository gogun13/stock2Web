	...
	$(document).ready(function(){
		...
		$('#btnSearch').click(function(){ 
			try{
				$("#pageIndex").val("1");
				$("#command").val("search");
				gp_postAjaxRequest("#frm", "#updateInvoiceCreditSearch-list");
			}catch(e){
...
<s:form name="frm" id="frm" action="updateInvoiceCreditSearchAction" onsubmit="return false;">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-left header">
                <h2>ปรับปรุงงบการขายเงินเชื่อ</h2>
            </div>
		</div>
		<div class="row">
		...
		<div class="panel panel-default">
			...
			<div class="row">
				<div id="updateInvoiceCreditSearch-list" class="col-sm-12">
			    	<%@include file="updateInvoiceCreditSearch-list.jsp" %>
				</div>
			</div>
		</div>
	</div>
