...
public class InvoiceCreditSearchAction extends BaseAction implements ActionControl{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(InvoiceCreditSearchAction.class);
    ...
    public String search()throws Exception {
    	...
    	try{
    		...
    		invoiceCreditBusiness.searchByCriteria(paginatedList, invoiceCreditMasterBean);
    	}catch(Exception e){
    		throw e;
    	}finally{
